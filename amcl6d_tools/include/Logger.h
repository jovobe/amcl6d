...
public:
	 ...
	 */
	void printTimes(const int times, const std::string str,
			const bool separator = false) const;
	...
	/**
	 * logs a double* as a double**
	 * @param a double* that can be interpreted as a double**
	 */
